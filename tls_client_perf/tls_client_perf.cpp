#include "tls_client_perf.hpp"


tls_client_perf_app::tls_client_perf_app(json app_json
                    , app_stats* zone_app_stats)
{
    ...
    for (auto it = cs_grp_list.begin(); it != cs_grp_list.end(); ++it)
    {
        ...
        tls_client_perf_cs_grp* next_cs_grp = new tls_client_perf_cs_grp (cs_grp_cfg
...
tls_client_perf_app::~tls_client_perf_app()
{

}

void tls_client_perf_app::run_iter(bool tick_sec)
{
    ...
    {
        tls_client_perf_cs_grp* cs_grp = m_cs_groups [m_cs_group_index];
        ...
        if (client_addr)
        {
            tls_client_perf_socket* client_socket = (tls_client_perf_socket*) 
...
ev_socket* tls_client_perf_app::alloc_socket()
{
    return new tls_client_perf_socket();
}

void tls_client_perf_app::free_socket(ev_socket* ev_sock)
{
    delete ev_sock;
}


void tls_client_perf_socket::ssl_init ()
{
...
void tls_client_perf_socket::on_establish ()
{
}

void tls_client_perf_socket::on_write ()
{
...
void tls_client_perf_socket::on_wstatus (int bytes_written, int write_status)
{
...
void tls_client_perf_socket::on_read ()
{
...
void tls_client_perf_socket::on_rstatus (int bytes_read, int read_status)
{    
    if (bytes_read == 0) 
    {
...
extern "C" {
    app* tls_client_perf (json app_json, app_stats* zone_app_stats) 
    {
        return new tls_client_perf_app (app_json, zone_app_stats);
    }
}
